...
const resources = {
  en: {
    translation: {
      ...
      analyticsSession: {
        title: 'Session Stats',
        emptyState: 'No session data available',
        totalSessions: 'Total Sessions',
        avgCostPerSession: 'Avg Cost/Session',
        recentActivity: 'Recent Activity',
      },
      analyticsCliproxy: {
        title: 'CLIProxy Stats',
        offline: 'Offline',
        error: 'Error',
        running: 'Running',
        emptyState: 'Start a CLIProxy session (gemini, codex, agy) to collect stats.',
        allSuccess: 'All success',
        failed: '{{count}} failed',
        totalTokens: 'Total tokens',
        modelsUsed: 'Models Used',
      },
      analyticsCostLeverage: {
        title: 'Cost Leverage Ratio',
        baselineLabel: 'Baseline 30d Cost ($)',
        baselinePlaceholder: 'e.g. 100',
        noBaseline: 'Set your baseline 30-day cost to see leverage ratio',
        saving: 'Saving...',
        saveError: 'Failed to save',
        invalidInput: 'Please enter a positive number',
        window7d: '7d',
        window30d: '30d',
        windowMonth: 'Month',
        costLabel: 'Cost',
      ...
      analyticsCursor: {
        title: 'Cursor Usage Import',
        importButton: 'Import CSV',
        importing: 'Importing...',
        successMessage: 'Import successful',
        errorMessage: 'Import failed',
        clearButton: 'Clear Data',
        clearConfirm: 'Clear all Cursor usage data?',
        statusNoData: 'No Cursor data imported',
        statusHasData: '{{count}} events imported',
        rowsLabel: 'Rows',
        dateLabel: 'Date Range',
        tokensLabel: 'Tokens',
        modelsLabel: 'Models',
        merged: 'Merged with existing data',
        fileHint: 'Export CSV from Cursor Dashboard → Settings → Usage',
      },
      analyticsCache: {
        title: 'Cache Efficiency',
        emptyState: 'No cache data available',
      ...
      analyticsInsights: {
        ...
        nominalDesc: 'Your usage patterns are within normal ranges for the selected period.',
        alerts: 'Alerts',
        alert: 'Alert',
        highInputVolume: 'High Input Volume',
        highIORatio: 'High I/O Ratio',
        costSpike: 'Cost Spike Detected',
        heavyCacheUsage: 'Heavy Cache Usage',
      },
      analyticsCostModel: {
        title: 'Cost by Model',
      ...
      analyticsToken: {
        emptyState: 'No token data available',
        input: 'Input',
        output: 'Output',
      ...
      analyticsModelDetail: {
        ...
        ioRatioTitle: 'Input/Output Ratio',
        ioDescHigh: 'Extended thinking or large context loading. Expected for reasoning models.',
        ioDescMedHigh: 'More input than output. Typical for analysis tasks.',
        ioDescBalanced: 'Balanced input/output ratio for typical coding tasks.',
        ioDescHighOutput: 'More output than input. Generation-heavy workload.',
      },
      apiProfiles: {
        title: 'API Profiles',
        new: 'New',
  ...
  'zh-CN': {
    translation: {
      ...
      analyticsCliproxy: {
        ...
        error: '错误',
        running: '运行中',
        emptyState: '启动 CLIProxy 会话（gemini、codex、agy）以收集统计数据。',
        allSuccess: '全部成功',
        failed: '{{count}} 个失败',
        totalTokens: '总 Token 数',
        modelsUsed: '已用模型',
      ...
      analyticsCostLeverage: {
        title: '成本杠杆率',
        baselineLabel: '原始 30d 成本 ($)',
        baselinePlaceholder: '例如 100',
        noBaseline: '设置原始 30 天成本以查看杠杆率',
        saving: '保存中...',
        saveError: '保存失败',
        invalidInput: '请输入正数',
        window7d: '近 7 天',
      ...
      analyticsCursor: {
        ...
        errorMessage: '导入失败',
        clearButton: '清除数据',
        clearConfirm: '清除所有 Cursor 用量数据？',
        statusNoData: '未导入 Cursor 数据',
        statusHasData: '已导入 {{count}} 条记录',
        rowsLabel: '行数',
        dateLabel: '日期范围',
        tokensLabel: '令牌数',
        modelsLabel: '模型',
        merged: '已与现有数据合并',
        fileHint: '从 Cursor Dashboard → Settings → Usage 导出 CSV',
      },
      analyticsCache: {
        title: '缓存效率',
        emptyState: '暂无缓存数据',
      ...
      analyticsInsights: {
        title: '使用洞察',
        allNominal: '所有系统正常',
        nominalDesc: '所选时段内的使用模式处于正常范围。',
        alerts: '告警',
        alert: '告警',
        highInputVolume: '高输入量',
        highIORatio: '高 I/O 比',
        costSpike: '检测到成本激增',
      ...
      analyticsModelDetail: {
        ...
        ioRatioTitle: '输入/输出比',
        ioDescHigh: '扩展思考或大量上下文加载，推理模型常见。',
        ioDescMedHigh: '输入多于输出，分析任务典型。',
        ioDescBalanced: '输入输出均衡，编码任务典型。',
        ioDescHighOutput: '输出多于输入，生成密集型工作负载。',
      },
      apiProfiles: {
        title: 'API 配置',
        new: '新建',
  ...
  vi: {
    translation: {
      ...
      analyticsSession: {
        ...
        emptyState: 'Chưa có dữ liệu phiên',
        totalSessions: 'Tổng số phiên',
        avgCostPerSession: 'Chi phí TB/phiên',
        recentActivity: 'Hoạt động gần đây',
      },
      analyticsCliproxy: {
        title: 'Thống kê CLIProxy',
        offline: 'Ngoại tuyến',
        error: 'Lỗi',
        running: 'Đang chạy',
        emptyState: 'Khởi chạy CLIProxy (gemini, codex, agy) để thu thập thống kê.',
        allSuccess: 'Tất cả thành công',
        failed: '{{count}} thất bại',
        totalTokens: 'Tổng token',
        modelsUsed: 'Mô hình đã dùng',
      },
      analyticsCostLeverage: {
        title: 'Tỷ lệ đòn bẩy chi phí',
        baselineLabel: 'Chi phí gốc 30d ($)',
        baselinePlaceholder: 'vd 100',
        noBaseline: 'Đặt chi phí gốc 30 ngày để xem tỷ lệ đòn bẩy',
        saving: 'Đang lưu...',
        saveError: 'Lưu thất bại',
        invalidInput: 'Vui lòng nhập số dương',
        window7d: '7 ngày',
        window30d: '30 ngày',
        windowMonth: 'Tháng',
        costLabel: 'Chi phí',
      ...
      analyticsCursor: {
        title: 'Nhập dữ liệu Cursor',
        importButton: 'Nhập CSV',
        importing: 'Đang nhập...',
        successMessage: 'Nhập thành công',
        errorMessage: 'Nhập thất bại',
        clearButton: 'Xóa dữ liệu',
        clearConfirm: 'Xóa tất cả dữ liệu sử dụng Cursor?',
        statusNoData: 'Chưa nhập dữ liệu Cursor',
        statusHasData: 'Đã nhập {{count}} sự kiện',
        rowsLabel: 'Số dòng',
        dateLabel: 'Phạm vi ngày',
        tokensLabel: 'Token',
        modelsLabel: 'Mô hình',
        merged: 'Đã hợp nhất với dữ liệu hiện có',
        fileHint: 'Xuất CSV từ Cursor Dashboard → Settings → Usage',
      },
      analyticsCache: {
        title: 'Hiệu suất bộ đệm',
        emptyState: 'Chưa có dữ liệu bộ đệm',
        estimatedSavings: 'Tiết kiệm ước tính',
        hitRate: 'Tỷ lệ trúng',
        cacheCost: 'Chi phí bộ đệm',
        reads: 'Lần đọc',
        writes: 'Lần ghi',
        read: 'Đọc',
        write: 'Ghi',
      ...
      analyticsInsights: {
        ...
        allNominal: 'Tất cả hệ thống bình thường',
        nominalDesc: 'Mẫu sử dụng của bạn trong khoảng bình thường cho giai đoạn đã chọn.',
        alerts: 'Cảnh báo',
        alert: 'Cảnh báo',
        highInputVolume: 'Khối lượng đầu vào cao',
        highIORatio: 'Tỷ lệ I/O cao',
        costSpike: 'Phát hiện tăng chi phí',
        heavyCacheUsage: 'Sử dụng bộ đệm nặng',
      },
      analyticsCostModel: {
      ...
      analyticsToken: {
        emptyState: 'Chưa có dữ liệu token',
        input: 'Đầu vào',
        output: 'Đầu ra',
        cacheWrite: 'Ghi bộ đệm',
        cacheRead: 'Đọc bộ đệm',
        tokens: 'Token',
        cost: 'Chi phí',
      },
      analyticsModelDetail: {
        ...
        ioRatioTitle: 'Tỷ lệ đầu vào/đầu ra',
        ioDescHigh: 'Suy nghĩ mở rộng hoặc tải ngữ cảnh lớn. Phổ biến với mô hình suy luận.',
        ioDescMedHigh: 'Đầu vào nhiều hơn đầu ra. Phổ biến với tác vụ phân tích.',
        ioDescBalanced: 'Tỷ lệ đầu vào/đầu ra cân bằng cho tác vụ lập trình.',
        ioDescHighOutput: 'Đầu ra nhiều hơn đầu vào. Khối lượng công việc nặng về tạo nội dung.',
      },
      apiProfiles: {
        title: 'Hồ sơ API',
        new: 'Mới',
