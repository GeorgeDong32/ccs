...
const resources = {
  en: {
    translation: {
      ...
      analyticsCursor: {
        fileHint: 'Import Cursor usage CSV export.',
        importButton: 'Import CSV',
        importing: 'Importing...',
        successMessage: 'Import successful',
        errorMessage: 'Import failed',
        clearConfirm: 'Clear all imported Cursor data?',
        clearButton: 'Clear imported data',
      },
      analyticsCostLeverage: {
        title: 'Cost Leverage Ratio',
        noBaseline: 'Set a 30-day baseline cost to see leverage ratios',
        baselinePlaceholder: 'Baseline cost (30d)',
        saving: 'Saving...',
      ...
      analyticsCards: {
        ...
        balancedRatioHint: 'Balanced input/output ratio for typical coding tasks.',
        sessionStats: 'Session Stats',
        recentActivity: 'Recent Activity',
        sampledSessions: 'Sampled Sessions',
        totalSessions: 'Total Sessions',
        recentAvgCost: 'Recent Avg Cost',
        ...
        allProfilesDesc: 'Includes all analytics sources.',
        defaultClaude: 'Default Claude',
        defaultClaudeDesc: 'Profile-scoped Claude JSONL data.',
      },
      dateRangeFilter: {
  ...
  'zh-CN': {
    translation: {
      ...
      analyticsCursor: {
        fileHint: '导入 Cursor 使用数据 CSV 导出文件。',
        importButton: '导入 CSV',
        importing: '导入中...',
        successMessage: '导入成功',
        errorMessage: '导入失败',
        clearConfirm: '清除所有已导入的 Cursor 数据？',
        clearButton: '清除已导入数据',
      },
      analyticsCostLeverage: {
        title: '成本杠杆率',
        noBaseline: '设置 30 天基线成本以查看杠杆率',
        baselinePlaceholder: '基线成本（30天）',
        saving: '保存中...',
        saveError: '保存失败',
        invalidInput: '请输入正数',
        window7d: '7天',
      ...
      analyticsCards: {
        ...
        balancedRatioHint: '典型编码任务的输入/输出均衡比例。',
        sessionStats: '会话统计',
        recentActivity: '最近活动',
        sampledSessions: '采样会话',
        totalSessions: '总会话数',
        recentAvgCost: '近期平均成本',
        avgCostPerSession: '平均每次会话成本',
        input: '输入',
        output: '输出',
        cacheWrite: '缓存写入',
        cacheRead: '缓存读取',
        allTokens: '全部 Token',
        extendedThinkingHint: '扩展思考或大上下文加载。推理模型常见。',
        analysisTaskHint: '输入大于输出。分析类任务常见。',
        generationHeavyHint: '输出大于输入。生成密集型工作负载。',
        allProfiles: '全部配置',
        allProfilesDesc: '包含所有分析数据源。',
        defaultClaude: '默认 Claude',
        defaultClaudeDesc: '按配置划分的 Claude JSONL 数据。',
      },
      dateRangeFilter: {
        pickADate: '选择日期',
      },
