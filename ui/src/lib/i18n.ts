...
const resources = {
  en: {
    translation: {
      ...
      analyticsCostLeverage: {
        ...
        invalidInput: 'Invalid value. Please enter a number between 0 and 1.',
        noBaseline: 'No baseline set. Enter a benchmark cost per million tokens to compare.',
        baselinePlaceholder: 'Baseline $/M input',
        saving: 'Saving',
  ...
  'zh-CN': {
    translation: {
      ...
      analyticsCostLeverage: {
        title: '成本杠杆率',
        invalidInput: '无效值。请输入 0 到 1 之间的数字。',
        noBaseline: '未设置基准。输入每百万 token 的基准成本进行比较。',
        baselinePlaceholder: '基准 $/M 输入',
        saving: '节省',
        saveError: '保存错误',
        window7d: '7 天',
        window30d: '30 天',
  ...
  vi: {
    translation: {
      ...
      analyticsCostLeverage: {
        ...
        invalidInput: 'Giá trị không hợp lệ. Vui lòng nhập số từ 0 đến 1.',
        noBaseline: 'Chưa đặt baseline. Nhập chi phí chuẩn mỗi triệu token để so sánh.',
        baselinePlaceholder: 'Baseline $/M đầu vào',
        saving: 'Tiết kiệm',
        saveError: 'Lỗi lưu',
        window7d: '7 Ngày',
        window30d: '30 Ngày',
        windowMonth: 'Tháng Này',
      },
      apiProfiles: {
        title: 'Hồ sơ API',
  ...
  ja: {
    translation: {
      ...
      analyticsCostLeverage: {
        title: 'コストレバレッジ比率',
        invalidInput: '無効な値です。0〜1 の数値を入力してください。',
        noBaseline:
          'ベースライン未設定。100万トークンあたりのベンチマークコストを入力してください。',
        baselinePlaceholder: 'ベースライン $/M 入力',
        saving: '節約',
        saveError: '保存エラー',
        window7d: '7 日間',
        window30d: '30 日間',
  ...
  ko: {
    translation: {
      ...
      analyticsCostLeverage: {
        title: '비용 레버리지 비율',
        invalidInput: '잘못된 값입니다. 0~1 사이의 숫자를 입력하세요.',
        noBaseline: '기준이 설정되지 않았습니다. 백만 토큰당 벤치마크 비용을 입력하세요.',
        baselinePlaceholder: '기준 $/M 입력',
        saving: '절약',
        saveError: '저장 오류',
        window7d: '7일',
        window30d: '30일',
